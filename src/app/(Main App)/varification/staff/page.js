...
const StaffVerification = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`/api/staff/varify?staffId=${staffID}&dob=${DOB}`);
  ...
  return (
    <div className="min-h-screen bg-[#e3f1f1] pb-14">
      <motion.div
      ...
      >
        <div className="px-8 py-6 bg-gradient-to-r from-blue-600 to-blue-500">
          <h2 className="text-center text-4xl sm:text-5xl font-bold text-[#1e90ff]">
